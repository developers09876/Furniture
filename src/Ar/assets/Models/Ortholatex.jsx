...
const Model = (props) => {
  ...
  useGLTF.preload('/model/Ortholatex.glb');

  const { nodes, materials } = useGLTF('/model/Ortholatex.glb');
...
{!props.chair && <ShadowReceiver position={[0,0,0]}/>}        
  ...
  }, [nodes, materials, currentColor, props.Ortholatex, props.rotation, props.scale, props.position]);
