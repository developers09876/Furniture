        ...
        <div className="chair-card" style={{boxShadow:"5px 5px 5px"}}>
          <Col lg={12} className="chair-card-pic1">
            <div className="chair-card-content">
              <h3>Comfortable Chair11</h3>
              <p>
                Domestic former turned of way it allowed loud visit. Unwanted in
                every of form. Domestic by in use
              </p>
              <Button type="text">View Now</Button>
            </div>
          </Col>{" "}
        </div>
        <div className="chair-card" style={{ boxShadow:"5px 5px 5px"}}>
          <Col>
            <div className="cnt-div">
              <div className="chair-card-content-2">
                <h3>Comfortable Chair11</h3>
                <p>
                  Domestic former turned of way it allowed loud visit. Unwanted
                  in every of form. Domestic by in use
                </p>
                <Button type="text">View Now</Button>
              </div>{" "}
            </div>
            <div className="chair-card-pic-2"></div>
          </Col>
        </div>
      </Row> */}
