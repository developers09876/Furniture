      ...
      <ServiceContainer className="container">
        <div className="row">
          <ServiceItem className="col-md-4 mb-4">
            ...
            <ServiceDescription>
              Explore a diverse collection of high-quality furniture to suit
          ...
          <ServiceItem className="col-md-4 mb-4">
            ...
            <ServiceDescription>
              Enjoy quick and reliable delivery services to get your furniture
          ...
          <ServiceItem className="col-md-4 mb-4">
            ...
            <ServiceDescription>
              Our furniture is crafted with precision, ensuring premium quality
              and durability.
            </ServiceDescription>
          </ServiceItem>
        </div>
